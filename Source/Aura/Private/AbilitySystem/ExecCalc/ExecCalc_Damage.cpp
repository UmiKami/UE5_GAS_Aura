                                              ...
                                              FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	UAuraAbilitySystemFunctionLibrary::SetIsBlockedHit(EffectContextHandle, bBlockSuccessful);
	...
	UAuraAbilitySystemFunctionLibrary::SetIsCriticalHit(EffectContextHandle,bCriticalHitSuccessful);
